...
class VoiceAlertService {
  ...
  static Future<void> init() async {
    ...
    try {
          ...
          for (final v in voices) {
            if (v is Map) {
              ...
              if ((locale.startsWith('hi') || locale.contains('IN')) &&
                ...
                debugPrint('[StoreVoiceAlert] Selected female voice: ${v['name']}');
                break;
              }
            }
          }
      ...
      debugPrint('[StoreVoiceAlert] TTS Init error: $e');
    }
  }
  ...
  static Future<void> speak(String text) async {
    ...
    try {
      ...
      debugPrint('[StoreVoiceAlert] Spoke: "$text"');
    } catch (e) {
      debugPrint('[StoreVoiceAlert] Error speaking: $e');
    }
  }

  /// Test voice sample for settings preview
  static Future<void> testVoice() async {
    await speak('Dhyan dein! Tapas Kumar ne Dharamshala ke liye 3 items ki nayi requisition bheji hai.');
  }
